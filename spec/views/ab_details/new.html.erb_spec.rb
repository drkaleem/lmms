...
describe "ab_details/new" do
  before(:each) do
    assign(:ab_detail, stub_model(AbDetail,
      :abmaster_id => 1,
  ...
  it "renders new ab_detail form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", ab_details_path, "post" do
